...
vim.api.nvim_set_keymap('n', '<C-_>', '<cmd>Commentary<CR>', { noremap = true })
...
vim.api.nvim_set_keymap('n', '<leader>gk', [[<cmd>diffget //2<CR>]], { noremap = true, silent = true })

-- Configure fsharp filetypes
vim.api.nvim_exec(
  [[
  augroup Fsharp
    autocmd!
...
local servers = { 'clangd', 'rust_analyzer', 'pyright', 'tsserver', 'fsautocomplete' }
